...
const u8 gText_DefaultNameStu[] = _("Aed");
const u8 gText_DefaultNameMilton[] = _("Aed");
const u8 gText_DefaultNameTom[] = _("Aed");
const u8 gText_DefaultNameKenny[] = _("Aed");
const u8 gText_DefaultNameReid[] = _("Aed");
const u8 gText_DefaultNameJude[] = _("Aed");
const u8 gText_DefaultNameJaxson[] = _("Aed");
const u8 gText_DefaultNameEaston[] = _("Aed");
const u8 gText_DefaultNameWalker[] = _("Aed");
const u8 gText_DefaultNameTeru[] = _("Aed");
const u8 gText_DefaultNameJohnny[] = _("Aed");
const u8 gText_DefaultNameBrett[] = _("Aed");
const u8 gText_DefaultNameSeth[] = _("Aed");
const u8 gText_DefaultNameTerry[] = _("Aed");
const u8 gText_DefaultNameCasey[] = _("Aed");
const u8 gText_DefaultNameDarren[] = _("Aed");
const u8 gText_DefaultNameLandon[] = _("Aed");
const u8 gText_DefaultNameCollin[] = _("Aed");
const u8 gText_DefaultNameStanley[] = _("Aed");
const u8 gText_DefaultNameQuincy[] = _("Aed");
const u8 gText_DefaultNameKimmy[] = _("Alpan");
const u8 gText_DefaultNameTiara[] = _("Alpan");
const u8 gText_DefaultNameBella[] = _("Alpan");
const u8 gText_DefaultNameJayla[] = _("Alpan");
const u8 gText_DefaultNameAllie[] = _("Alpan");
const u8 gText_DefaultNameLianna[] = _("Alpan");
const u8 gText_DefaultNameSara[] = _("Alpan");
const u8 gText_DefaultNameMonica[] = _("Alpan");
const u8 gText_DefaultNameCamila[] = _("Alpan");
const u8 gText_DefaultNameAubree[] = _("Alpan");
const u8 gText_DefaultNameRuthie[] = _("Alpan");
const u8 gText_DefaultNameHazel[] = _("Alpan");
const u8 gText_DefaultNameNadine[] = _("Alpan");
const u8 gText_DefaultNameTanja[] = _("Alpan");
const u8 gText_DefaultNameYasmin[] = _("Alpan");
const u8 gText_DefaultNameNicola[] = _("Alpan");
const u8 gText_DefaultNameLillie[] = _("Alpan");
const u8 gText_DefaultNameTerra[] = _("Alpan");
const u8 gText_DefaultNameLucy[] = _("Alpan");
const u8 gText_DefaultNameHalie[] = _("Alpan");
const u8 gText_ThisIsAPokemon[] = _("This POKéMON here...{PAUSE 96}\p");
